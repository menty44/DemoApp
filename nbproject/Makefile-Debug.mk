...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/Debug/DemoApp.exe

dist/V3/Debug/DemoApp.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/Debug
	arm-brcm-linux-gnueabi-g++ -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}" -o dist/V3/Debug/DemoApp  ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/cardlessdeposit.o: cardlessdeposit.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/cardlessdeposit.o cardlessdeposit.c

${OBJECTDIR}/settings.o: settings.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/settings.o settings.c
...
${OBJECTDIR}/deposit.o: deposit.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/deposit.o deposit.c
...
${OBJECTDIR}/ussd.o: ussd.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/ussd.o ussd.c
